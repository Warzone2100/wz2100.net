---
title: "Version 4.7.0-beta2 available"
date: 2026-04-05 # no-translate
draft: false # no-translate
slug: "version-4-7-0-beta2"
tags:
  - "Releases"
---

A beta release of 4.7.0, **4.7.0-beta2**, is available for testing! Please test it intensively so that we may soon push out the final 4.7.0.

**It is available at the usual locations:**
- **Windows installer**: [GitHub](https://github.com/Warzone2100/warzone2100/releases/download/4.7.0-beta2/warzone2100_win_installer.exe) | [SourceForge](https://sourceforge.net/projects/warzone2100/files/releases/4.7.0-beta2/warzone2100_win_installer.exe/download)
- **macOS .zip**: [GitHub](https://github.com/Warzone2100/warzone2100/releases/download/4.7.0-beta2/warzone2100_macOS_universal.zip) | [SourceForge](https://sourceforge.net/projects/warzone2100/files/releases/4.7.0-beta2/warzone2100_macOS_universal.zip/download)
- Linux builds, source, other files: [GitHub](https://github.com/Warzone2100/warzone2100/releases/tag/4.7.0-beta2) | [SourceForge](https://sourceforge.net/projects/warzone2100/files/releases/4.7.0-beta2/)
...
[View the full 4.7.0-beta2 changelog](https://github.com/Warzone2100/warzone2100/raw/4.7.0-beta2/ChangeLog)
